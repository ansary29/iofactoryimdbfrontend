...
const Addproducer = () => {
    ...
    const notifyaddingproducer=()=> toast.success("Search for added producer!")
    async function addProducer(){
        try {
            setDisp('none')
            await axios.post('https://imdbbackend12.onrender.com/crew/createproducer',{
            name,dob,bio,gender
        },{
            headers:{
                "access-token":token
    ...
    <div className="modal fade" id="exampleModal2" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog">
                        ...
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel">Add new Producer</h1>
                        ...
                        {(name=='' || bio=='' || dob=='' || gender=='')?'':<button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={addProducer} style={styles1}>Add</button>}
